...
public partial class AesGcmCtrV1 : TBase
{
  ...
  {
    var tmp323 = new AesGcmCtrV1();
    if((Aad_prefix != null) && __isset.aad_prefix)
    {
      tmp323.Aad_prefix = this.Aad_prefix.ToArray();
    }
    tmp323.__isset.aad_prefix = this.__isset.aad_prefix;
    if((Aad_file_unique != null) && __isset.aad_file_unique)
    {
      tmp323.Aad_file_unique = this.Aad_file_unique.ToArray();
    }
    tmp323.__isset.aad_file_unique = this.__isset.aad_file_unique;
    if(__isset.supply_aad_prefix)
    {
      tmp323.Supply_aad_prefix = this.Supply_aad_prefix;
    }
    tmp323.__isset.supply_aad_prefix = this.__isset.supply_aad_prefix;
    return tmp323;
  }
  ...
  {
    var tmp326 = new StringBuilder("AesGcmCtrV1(");
    int tmp327 = 0;
    if((Aad_prefix != null) && __isset.aad_prefix)
    {
      if(0 < tmp327++) { tmp326.Append(", "); }
      tmp326.Append("Aad_prefix: ");
      Aad_prefix.ToString(tmp326);
    }
    if((Aad_file_unique != null) && __isset.aad_file_unique)
    {
      if(0 < tmp327++) { tmp326.Append(", "); }
      tmp326.Append("Aad_file_unique: ");
      Aad_file_unique.ToString(tmp326);
    }
    if(__isset.supply_aad_prefix)
    {
      if(0 < tmp327++) { tmp326.Append(", "); }
      tmp326.Append("Supply_aad_prefix: ");
      Supply_aad_prefix.ToString(tmp326);
    }
    tmp326.Append(')');
