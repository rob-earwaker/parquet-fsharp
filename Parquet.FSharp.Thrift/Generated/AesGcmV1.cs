...
public partial class AesGcmV1 : TBase
{
  ...
  {
    var tmp318 = new AesGcmV1();
    if((Aad_prefix != null) && __isset.aad_prefix)
    {
      tmp318.Aad_prefix = this.Aad_prefix.ToArray();
    }
    tmp318.__isset.aad_prefix = this.__isset.aad_prefix;
    if((Aad_file_unique != null) && __isset.aad_file_unique)
    {
      tmp318.Aad_file_unique = this.Aad_file_unique.ToArray();
    }
    tmp318.__isset.aad_file_unique = this.__isset.aad_file_unique;
    if(__isset.supply_aad_prefix)
    {
      tmp318.Supply_aad_prefix = this.Supply_aad_prefix;
    }
    tmp318.__isset.supply_aad_prefix = this.__isset.supply_aad_prefix;
    return tmp318;
  }
  ...
  public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var tmp319 = new TStruct("AesGcmV1");
      await oprot.WriteStructBeginAsync(tmp319, cancellationToken);
      var tmp320 = new TField();
      if((Aad_prefix != null) && __isset.aad_prefix)
      {
        tmp320.Name = "aad_prefix";
        tmp320.Type = TType.String;
        tmp320.ID = 1;
        await oprot.WriteFieldBeginAsync(tmp320, cancellationToken);
        await oprot.WriteBinaryAsync(Aad_prefix, cancellationToken);
        await oprot.WriteFieldEndAsync(cancellationToken);
      }
      if((Aad_file_unique != null) && __isset.aad_file_unique)
      {
        tmp320.Name = "aad_file_unique";
        tmp320.Type = TType.String;
        tmp320.ID = 2;
        await oprot.WriteFieldBeginAsync(tmp320, cancellationToken);
      ...
      if(__isset.supply_aad_prefix)
      {
        tmp320.Name = "supply_aad_prefix";
        tmp320.Type = TType.Bool;
        tmp320.ID = 3;
        await oprot.WriteFieldBeginAsync(tmp320, cancellationToken);
  ...
  {
    var tmp321 = new StringBuilder("AesGcmV1(");
    int tmp322 = 0;
    if((Aad_prefix != null) && __isset.aad_prefix)
    {
      if(0 < tmp322++) { tmp321.Append(", "); }
      tmp321.Append("Aad_prefix: ");
      Aad_prefix.ToString(tmp321);
    }
    if((Aad_file_unique != null) && __isset.aad_file_unique)
    {
      if(0 < tmp322++) { tmp321.Append(", "); }
      tmp321.Append("Aad_file_unique: ");
      Aad_file_unique.ToString(tmp321);
    }
    if(__isset.supply_aad_prefix)
    {
      if(0 < tmp322++) { tmp321.Append(", "); }
      tmp321.Append("Supply_aad_prefix: ");
      Supply_aad_prefix.ToString(tmp321);
    }
    tmp321.Append(')');
