...
public partial class BloomFilterHeader : TBase
{
  ...
  public BloomFilterHeader DeepCopy()
  {
    ...
    if((Algorithm != null))
    {
      tmp180.Algorithm = (BloomFilterAlgorithm)this.Algorithm.DeepCopy();
    }
    if((Hash != null))
    {
      tmp180.Hash = (BloomFilterHash)this.Hash.DeepCopy();
    }
    if((Compression != null))
    {
      tmp180.Compression = (BloomFilterCompression)this.Compression.DeepCopy();
    }
    return tmp180;
  }
