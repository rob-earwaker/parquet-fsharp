...
public partial class Float16Type : TBase
{
  ...
  public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var tmp57 = new TStruct("Float16Type");
  ...
  {
    if (!(that is Float16Type other)) return false;
  ...
  {
    var tmp58 = new StringBuilder("Float16Type(");
    tmp58.Append(')');
