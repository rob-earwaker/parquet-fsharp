...
public partial class PageHeader : TBase
{
  ...
  public PageHeader DeepCopy()
  {
    ...
    {
      tmp185.Data_page_header = (DataPageHeader)this.Data_page_header.DeepCopy();
    }
    tmp185.__isset.data_page_header = this.__isset.data_page_header;
    if((Index_page_header != null) && __isset.index_page_header)
    {
      tmp185.Index_page_header = (IndexPageHeader)this.Index_page_header.DeepCopy();
    }
    ...
    {
      tmp185.Dictionary_page_header = (DictionaryPageHeader)this.Dictionary_page_header.DeepCopy();
    }
    ...
    {
      tmp185.Data_page_header_v2 = (DataPageHeaderV2)this.Data_page_header_v2.DeepCopy();
    }
