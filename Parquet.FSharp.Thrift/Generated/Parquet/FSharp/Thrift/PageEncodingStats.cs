...
namespace Parquet.FSharp.Thrift
{
  ...
  public partial class PageEncodingStats : TBase
  {
    ...
    /// </summary>
    public global::Parquet.FSharp.Thrift.PageType Page_type { get; set; }
    ...
    public PageEncodingStats(global::Parquet.FSharp.Thrift.PageType page_type, global::Parquet.FSharp.Thrift.Encoding @encoding, int @count) : this()
    {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                Page_type = (global::Parquet.FSharp.Thrift.PageType)await iprot.ReadI32Async(cancellationToken);
