...
namespace Parquet.FSharp.Thrift
{
  ...
  public partial class TimeType : TBase
  {
    ...
    public TimeType(bool isAdjustedToUTC, global::Parquet.FSharp.Thrift.TimeUnit @unit) : this()
    {
    ...
    public TimeType DeepCopy()
    {
      ...
      if((Unit != null))
      {
        tmp91.Unit = (global::Parquet.FSharp.Thrift.TimeUnit)this.Unit.DeepCopy();
      }
      return tmp91;
    }
