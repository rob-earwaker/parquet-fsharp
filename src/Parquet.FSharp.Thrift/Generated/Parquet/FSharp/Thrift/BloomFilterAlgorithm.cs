...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private global::Parquet.FSharp.Thrift.SplitBlockAlgorithm _BLOCK;

    /// <summary>
    /// Block-based Bloom filter. *
    /// </summary>
    public global::Parquet.FSharp.Thrift.SplitBlockAlgorithm BLOCK
    {
      get
      {
        return _BLOCK;
    ...
    public BloomFilterAlgorithm DeepCopy()
    {
      ...
      {
        tmp157.BLOCK = (global::Parquet.FSharp.Thrift.SplitBlockAlgorithm)this.BLOCK.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                BLOCK = new global::Parquet.FSharp.Thrift.SplitBlockAlgorithm();
