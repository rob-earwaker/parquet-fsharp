...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private global::Parquet.FSharp.Thrift.Uncompressed _UNCOMPRESSED;

    public global::Parquet.FSharp.Thrift.Uncompressed UNCOMPRESSED
    {
      get
      {
    ...
    public BloomFilterCompression DeepCopy()
    {
      ...
      {
        tmp175.UNCOMPRESSED = (global::Parquet.FSharp.Thrift.Uncompressed)this.UNCOMPRESSED.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                UNCOMPRESSED = new global::Parquet.FSharp.Thrift.Uncompressed();
