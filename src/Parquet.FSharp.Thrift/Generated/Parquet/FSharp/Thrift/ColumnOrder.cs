...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private global::Parquet.FSharp.Thrift.TypeDefinedOrder _TYPE_ORDER;
    ...
    /// </summary>
    public global::Parquet.FSharp.Thrift.TypeDefinedOrder TYPE_ORDER
    {
      get
      {
        return _TYPE_ORDER;
    ...
    {
      var tmp266 = new ColumnOrder();
      if((TYPE_ORDER != null) && __isset.TYPE_ORDER)
      {
        tmp266.TYPE_ORDER = (global::Parquet.FSharp.Thrift.TypeDefinedOrder)this.TYPE_ORDER.DeepCopy();
      }
      tmp266.__isset.TYPE_ORDER = this.__isset.TYPE_ORDER;
      return tmp266;
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                TYPE_ORDER = new global::Parquet.FSharp.Thrift.TypeDefinedOrder();
    ...
    {
      var tmp269 = new StringBuilder("ColumnOrder(");
      int tmp270 = 0;
      if((TYPE_ORDER != null) && __isset.TYPE_ORDER)
      {
        if(0 < tmp270++) { tmp269.Append(", "); }
        tmp269.Append("TYPE_ORDER: ");
        TYPE_ORDER.ToString(tmp269);
      }
      tmp269.Append(')');
