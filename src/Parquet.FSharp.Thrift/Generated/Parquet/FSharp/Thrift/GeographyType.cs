...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private string _crs;
    private global::Parquet.FSharp.Thrift.EdgeInterpolationAlgorithm _algorithm;
    ...
    /// <summary>
    /// 
    /// <seealso cref="global::Parquet.FSharp.Thrift.EdgeInterpolationAlgorithm"/>
    /// </summary>
    public global::Parquet.FSharp.Thrift.EdgeInterpolationAlgorithm Algorithm
    {
      get
      {
        return _algorithm;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                Algorithm = (global::Parquet.FSharp.Thrift.EdgeInterpolationAlgorithm)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
