...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private List<global::Parquet.FSharp.Thrift.SortingColumn> _sorting_columns;
    ...
    /// 
    /// </summary>
    public List<global::Parquet.FSharp.Thrift.ColumnChunk> Columns { get; set; }
    ...
    /// </summary>
    public List<global::Parquet.FSharp.Thrift.SortingColumn> Sorting_columns
    {
      get
      {
    ...
    public RowGroup(List<global::Parquet.FSharp.Thrift.ColumnChunk> @columns, long total_byte_size, long num_rows) : this()
    {
              ...
              {
                {
                  ...
                  Columns = new List<global::Parquet.FSharp.Thrift.ColumnChunk>(_list250.Count);
                  for(int _i251 = 0; _i251 < _list250.Count; ++_i251)
                  {
                    global::Parquet.FSharp.Thrift.ColumnChunk _elem252;
                    _elem252 = new global::Parquet.FSharp.Thrift.ColumnChunk();
              ...
              {
                {
                  ...
                  Sorting_columns = new List<global::Parquet.FSharp.Thrift.SortingColumn>(_list253.Count);
                  for(int _i254 = 0; _i254 < _list253.Count; ++_i254)
                  {
                    global::Parquet.FSharp.Thrift.SortingColumn _elem255;
                    _elem255 = new global::Parquet.FSharp.Thrift.SortingColumn();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((Columns != null))
        {
          ...
          foreach (global::Parquet.FSharp.Thrift.ColumnChunk _iter258 in Columns)
          {
        ...
        if((Sorting_columns != null) && __isset.sorting_columns)
        {
          ...
          foreach (global::Parquet.FSharp.Thrift.SortingColumn _iter259 in Sorting_columns)
          {
