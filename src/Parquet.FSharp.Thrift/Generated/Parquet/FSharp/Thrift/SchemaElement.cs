...
namespace Parquet.FSharp.Thrift
{
  ...
  {
    private global::Parquet.FSharp.Thrift.Type _type;
    private int _type_length;
    private global::Parquet.FSharp.Thrift.FieldRepetitionType _repetition_type;
    private int _num_children;
    private global::Parquet.FSharp.Thrift.ConvertedType _converted_type;
    private int _scale;
    private int _precision;
    private int _field_id;
    private global::Parquet.FSharp.Thrift.LogicalType _logicalType;
    ...
    /// </summary>
    public global::Parquet.FSharp.Thrift.Type Type
    {
      get
      {
        return _type;
    ...
    /// 
    /// <seealso cref="global::Parquet.FSharp.Thrift.FieldRepetitionType"/>
    /// </summary>
    public global::Parquet.FSharp.Thrift.FieldRepetitionType Repetition_type
    {
      get
      {
    ...
    /// 
    /// <seealso cref="global::Parquet.FSharp.Thrift.ConvertedType"/>
    /// </summary>
    public global::Parquet.FSharp.Thrift.ConvertedType Converted_type
    {
      get
      {
    ...
    /// </summary>
    public global::Parquet.FSharp.Thrift.LogicalType LogicalType
    {
      get
      {
        return _logicalType;
    ...
    {
      var tmp129 = new SchemaElement();
      if(__isset.@type)
      {
        tmp129.Type = this.Type;
      }
      tmp129.__isset.@type = this.__isset.@type;
      if(__isset.type_length)
      {
        tmp129.Type_length = this.Type_length;
      }
      tmp129.__isset.type_length = this.__isset.type_length;
      if(__isset.repetition_type)
      {
        tmp129.Repetition_type = this.Repetition_type;
      }
      tmp129.__isset.repetition_type = this.__isset.repetition_type;
      if((Name != null))
      {
        tmp129.Name = this.Name;
      }
      if(__isset.num_children)
      {
        tmp129.Num_children = this.Num_children;
      }
      tmp129.__isset.num_children = this.__isset.num_children;
      if(__isset.converted_type)
      {
        tmp129.Converted_type = this.Converted_type;
      }
      tmp129.__isset.converted_type = this.__isset.converted_type;
      if(__isset.@scale)
      {
        tmp129.Scale = this.Scale;
      }
      tmp129.__isset.@scale = this.__isset.@scale;
      if(__isset.@precision)
      {
        tmp129.Precision = this.Precision;
      }
      tmp129.__isset.@precision = this.__isset.@precision;
      if(__isset.field_id)
      {
        tmp129.Field_id = this.Field_id;
      }
      tmp129.__isset.field_id = this.__isset.field_id;
      if((LogicalType != null) && __isset.logicalType)
      {
        tmp129.LogicalType = (global::Parquet.FSharp.Thrift.LogicalType)this.LogicalType.DeepCopy();
      }
      tmp129.__isset.logicalType = this.__isset.logicalType;
      return tmp129;
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.I32)
              {
                Repetition_type = (global::Parquet.FSharp.Thrift.FieldRepetitionType)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
            ...
            case 6:
              if (field.Type == TType.I32)
              {
                Converted_type = (global::Parquet.FSharp.Thrift.ConvertedType)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
            ...
            case 10:
              ...
              {
                LogicalType = new global::Parquet.FSharp.Thrift.LogicalType();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp130 = new TStruct("SchemaElement");
    ...
    {
      var tmp132 = new StringBuilder("SchemaElement(");
      int tmp133 = 0;
      if(__isset.@type)
      {
        if(0 < tmp133++) { tmp132.Append(", "); }
        tmp132.Append("Type: ");
        Type.ToString(tmp132);
      }
      if(__isset.type_length)
      {
        if(0 < tmp133++) { tmp132.Append(", "); }
        tmp132.Append("Type_length: ");
        Type_length.ToString(tmp132);
      }
      if(__isset.repetition_type)
      {
        if(0 < tmp133++) { tmp132.Append(", "); }
        tmp132.Append("Repetition_type: ");
        Repetition_type.ToString(tmp132);
      }
      if((Name != null))
      {
        if(0 < tmp133) { tmp132.Append(", "); }
        tmp132.Append("Name: ");
        Name.ToString(tmp132);
      }
      if(__isset.num_children)
      {
        tmp132.Append(", Num_children: ");
        Num_children.ToString(tmp132);
      }
      if(__isset.converted_type)
      {
        tmp132.Append(", Converted_type: ");
        Converted_type.ToString(tmp132);
      }
      if(__isset.@scale)
      {
        tmp132.Append(", Scale: ");
        Scale.ToString(tmp132);
      }
      if(__isset.@precision)
      {
        tmp132.Append(", Precision: ");
        Precision.ToString(tmp132);
      }
      if(__isset.field_id)
      {
        tmp132.Append(", Field_id: ");
        Field_id.ToString(tmp132);
      }
      if((LogicalType != null) && __isset.logicalType)
      {
        tmp132.Append(", LogicalType: ");
        LogicalType.ToString(tmp132);
      }
      tmp132.Append(')');
