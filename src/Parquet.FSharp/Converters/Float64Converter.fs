...
type internal Float64ConverterSettings = {
    Optional: bool }
    with
    static member val Default = {
        Float64ConverterSettings.Optional = false }

type internal Float64Converter(converterSettings: Float64ConverterSettings) =
    let dotnetType = typeof<float>
    let dataDotnetType = typeof<float>
    ...
    static member val Default = Float64Converter(Float64ConverterSettings.Default)
