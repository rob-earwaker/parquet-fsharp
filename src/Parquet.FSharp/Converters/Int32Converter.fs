...
type internal Int32ConverterSettings = {
    Optional: bool }
    with
    static member val Default = {
        Int32ConverterSettings.Optional = false }

type internal Int32Converter(converterSettings: Int32ConverterSettings) =
    let dotnetType = typeof<int32>
    let dataDotnetType = typeof<int32>
    ...
    static member val Default = Int32Converter(Int32ConverterSettings.Default)
