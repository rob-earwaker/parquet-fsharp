...
type internal NullableConverterSettings = {
    Required: bool }
    with
    static member val Default = {
        NullableConverterSettings.Required = false }

type internal NullableConverter(converterSettings: NullableConverterSettings) =
    ...
    static member val Default = NullableConverter(NullableConverterSettings.Default)
