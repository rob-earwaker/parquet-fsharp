...
type internal UInt16ConverterSettings = {
    Optional: bool }
    with
    static member val Default = {
        UInt16ConverterSettings.Optional = false }

type internal UInt16Converter(converterSettings: UInt16ConverterSettings) =
    let dotnetType = typeof<uint16>
    let dataDotnetType = typeof<uint16>
    ...
    static member val Default = UInt16Converter(UInt16ConverterSettings.Default)
