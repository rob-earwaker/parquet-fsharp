    ...
    let assertSchemaMatchesExpected schema =
        Assert.schema schema [
            Assert.field [
                ...
                Assert.Field.isRequired
                Assert.Field.Type.isInt64
                Assert.Field.LogicalType.isTimestamp "local" "milliseconds"
                Assert.Field.ConvertedType.hasNoValue
                Assert.Field.hasNoChildren ] ]
...
module ``{ unit=milliseconds; local=true; optional=true } serialize`` =
    type Input = {
        [<ParquetDateTime(Unit = TimeUnit.Milliseconds, Local = true, Optional = true)>]
        Field1: DateTime }

    type Output = {
        [<ParquetDateTime(NestingLevel = 1, Unit = TimeUnit.Milliseconds, Local = true)>]
        Field1: DateTime option }
    ...
    let assertSchemaMatchesExpected schema =
        Assert.schema schema [
            Assert.field [
                ...
                Assert.Field.isRequired
                Assert.Field.Type.isInt64
                Assert.Field.LogicalType.isTimestamp "local" "nanoseconds"
                Assert.Field.ConvertedType.hasNoValue
                Assert.Field.hasNoChildren ] ]
...
module ``{ unit=nanoseconds; local=true; optional=true } serialize`` =
    type Input = {
        [<ParquetDateTime(Unit = TimeUnit.Nanoseconds, Local = true, Optional = true)>]
        Field1: DateTime }

    type Output = {
        [<ParquetDateTime(NestingLevel = 1, Unit = TimeUnit.Nanoseconds, Local = true)>]
        Field1: DateTime option }
...
module ``{ unit=milliseconds; local=true; optional=true } deserialize`` =
    type Input = {
        [<ParquetDateTime(NestingLevel = 1, Unit = TimeUnit.Milliseconds, Local = true)>]
        Field1: DateTime option }
...
module ``{ unit=nanoseconds; local=true; optional=true } deserialize`` =
    type Input = {
        [<ParquetDateTime(NestingLevel = 1, Unit = TimeUnit.Nanoseconds, Local = true)>]
        Field1: DateTime option }
