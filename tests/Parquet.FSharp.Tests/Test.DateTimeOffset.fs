...
module ``{ unit=microseconds } serialize`` =
    type Input = { [<ParquetDateTimeOffset(Unit = TimeUnit.Microseconds)>] Field1: DateTimeOffset }
    type Output = { Field1: DateTime }
...
module ``{ optional=false } serialize`` =
    type Input = { [<ParquetDateTimeOffset(Optional = false)>] Field1: DateTimeOffset }
    type Output = { Field1: DateTime }
...
module ``{ unit=microseconds } deserialize`` =
    type Input = { Field1: DateTime }
    type Output = { [<ParquetDateTimeOffset(Unit = TimeUnit.Microseconds)>] Field1: DateTimeOffset }
...
module ``{ optional=false } deserialize`` =
    type Input = { Field1: DateTime }
    type Output = { [<ParquetDateTimeOffset(Optional = false)>] Field1: DateTimeOffset }
