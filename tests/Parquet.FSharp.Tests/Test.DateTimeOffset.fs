...
module ``{ unit=milliseconds; optional=false } serialize`` =
    type Input = {
        [<ParquetDateTimeOffset(Unit = TimeUnit.Milliseconds, Optional = false)>]
...
module ``{ unit=microseconds; optional=false } serialize`` =
    type Input = {
        [<ParquetDateTimeOffset(Unit = TimeUnit.Microseconds, Optional = false)>]
        Field1: DateTimeOffset }
...
module ``{ unit=microseconds; optional=true } serialize`` =
    type Input = {
        [<ParquetDateTimeOffset(Unit = TimeUnit.Microseconds, Optional = true)>]
        Field1: DateTimeOffset }
...
module ``{ unit=nanoseconds; optional=false } serialize`` =
    type Input = {
        [<ParquetDateTimeOffset(Unit = TimeUnit.Nanoseconds, Optional = false)>]
        Field1: DateTimeOffset }
...
module ``{ unit=milliseconds; optional=false } deserialize`` =
    type Input = {
        [<ParquetDateTime(Unit = TimeUnit.Milliseconds)>]
        Field1: DateTime }
...
module ``{ unit=microseconds; optional=false } deserialize`` =
    type Input = { Field1: DateTime }
...
module ``{ unit=microseconds; optional=true } deserialize`` =
...
module ``{ unit=nanoseconds; optional=false } deserialize`` =
    type Input = {
        [<ParquetDateTime(Unit = TimeUnit.Nanoseconds)>]
        Field1: DateTime }
