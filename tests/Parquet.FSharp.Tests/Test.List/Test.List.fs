        ...
        raisesWith<SerializationException>
            ...
            (fun exn ->
                <@ exn.Message =
                    ...
                    + $" '{typeof<int list>}' which is not optional by default" @>)
    ...
    let ``null`` () =
        ...
        raisesWith<SerializationException>
            ...
            (fun exn ->
                <@ exn.Message =
                    "null value encountered during serialization for type"
                    + $" '{typeof<int list list>}' which is not optional by default" @>)
    ...
    let ``null`` () =
        ...
        raisesWith<SerializationException>
            ...
            (fun exn ->
                <@ exn.Message =
                    "null value encountered during serialization for type"
                    + $" '{typeof<Record list>}' which is not optional by default" @>)
    ...
    let ``null`` () =
        ...
        raisesWith<SerializationException>
            ...
            (fun exn ->
                <@ exn.Message =
                    "null value encountered during serialization for type"
                    + $" '{typeof<int option list>}' which is not optional by default" @>)
...
module ``{ allowNull=true } serialize with atomic elements`` =
    type Input = { [<ParquetList(AllowNull = true)>] Field1: int list }
    type Output = { Field1: int list }
...
module ``{ allowNull=true } serialize with list elements`` =
    type Input = { [<ParquetList(AllowNull = true)>] Field1: int list list }
    type Output = { Field1: int list list }
...
module ``{ allowNull=true } serialize with record elements`` =
    type Record = { Field2: int }
    type Input = { [<ParquetList(AllowNull = true)>] Field1: Record list }
    type Output = { Field1: Record list }
...
module ``{ allowNull=true } serialize with optional elements`` =
    type Input = { [<ParquetList(AllowNull = true)>] Field1: int option list }
    type Output = { Field1: int option list }
