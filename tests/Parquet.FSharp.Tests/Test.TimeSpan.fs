...
module ``{ optional=false } serialize`` =
    type Input = { [<ParquetTimeSpan(Optional = false)>] Field1: TimeSpan }
    type Output = { Field1: int64 }
...
module ``{ optional=true } serialize`` =
    type Input = { [<ParquetTimeSpan(Optional = true)>] Field1: TimeSpan }
...
module ``{ optional=false } deserialize`` =
    type Input = { Field1: int64 }
    type Output = { [<ParquetTimeSpan(Optional = false)>] Field1: TimeSpan }
...
module ``{ optional=true } deserialize`` =
    ...
    type Output = { [<ParquetTimeSpan(Optional = true)>] Field1: TimeSpan }
