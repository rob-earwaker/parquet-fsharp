...
module ``{ optional=false; allowNull=false } serialize`` =
    type Union = Case1 | Case2 of field2:int
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
...
module ``{ optional=false; allowNull=true } serialize`` =
    type Union = Case1 | Case2 of field2:int
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
...
module ``{ optional=true; allowNull=false } serialize`` =
    type Union = Case1 | Case2 of field2:int
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
...
module ``{ optional=false; allowNull=false } deserialize`` =
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
    type Union = Case1 | Case2 of field2:int
    type Input = { Field1: UnionRecord }
...
module ``{ optional=false; allowNull=true } deserialize`` =
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
    type Union = Case1 | Case2 of field2:int
    type Input = { Field1: UnionRecord }
...
module ``{ optional=true; allowNull=false } deserialize`` =
    type Case2Record = { field2: int }
    type UnionRecord = { Type: string; Case2: Case2Record option }
    type Union = Case1 | Case2 of field2:int
